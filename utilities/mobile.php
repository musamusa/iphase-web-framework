...
class mobile{
	...
	{
		if(request::getCmd("d",'','get') == 'mobile'){
			return true;
		}else
		if(request::getCmd("d",'','get') == 'desktop'){
			return false;
		}else
	...
	public static function truedevice(){
		if(preg_match('/(alcatel|amoi|android|avantgo|blackberry|benq|cell|cricket|docomo|elaine|htc|iemobile|iphone|ipad|ipaq|ipod|j2me|java|midp|mini|mmp|mobi|motorola|nec-|nokia|palm|panasonic|philips|phone|sagem|sharp|sie-|smartphone|sony|symbian|t-mobile|telus|up\.browser|up\.link|vodafone|wap|webos|wireless|xda|xoom|zte)/i', $_SERVER['HTTP_USER_AGENT']))
		{	return true;}
	...
	public static function mobile_device($iphone=true,$ipad=true,$android=true,$opera=true,$blackberry=true,$palm=true,$windows=true,$mobileredirect=false,$desktopredirect=false){
		$mobile = new mobile;
		return $mobile->mobile_device_detect($iphone,$ipad,$android,$opera,$blackberry,$palm,$windows,$mobileredirect,$desktopredirect);
	} 
	public static function mdetect()
	{
		$mobile = new mobile;
		return $mobile->detect_mobile();
	}
	
	public static function mtype()
	{
		preg_match('/(alcatel|amoi|android|avantgo|blackberry|benq|cell|cricket|docomo|elaine|htc|iemobile|iphone|ipad|ipaq|ipod|j2me|java|midp|mini|mmp|mobi|motorola|nec-|nokia|palm|panasonic|philips|phone|sagem|sharp|sie-|smartphone|sony|symbian|t-mobile|telus|up\.browser|up\.link|vodafone|wap|webos|wireless|xda|xoom|zte)/i', $_SERVER['HTTP_USER_AGENT'], $match);
		return $match[0];
	}
