<?php
/**
 * @version		$Id: simplexml.php 20196 2011-01-09 02:40:25Z ian $
 * @package		.Framework
 ...
 *
 * The XML Parser extension (expat) is required to use SimpleXML.
 *
 ...
 * SimpleXML, not implicit as with PHP5. Write
 ...
 * @deprecated
 */
class SimpleXML extends Object
{
	/**
	 * The XML parser
	 *
	...
	*/
	 ...
	 * SimpleXMLElement with properties containing the data held within the xml document.
	 ...
	 * to an object  of class SimpleXMLElement. If any errors occur during file access or
	 ...
	 * This new object can then be used as a native SimpleXML element. If any errors occur,
	 * it returns FALSE.
	 *
	...
	{
		Error::raiseWarning('XML Parsing Error at '.$line.':'.$col.'. Error '.$code.': '.xml_error_string($code));
	}
 ...
 * @deprecated
 */
class SimpleXMLElement extends Object
{
	/**
	 ...
	 * @param array		$attrs
	 * @param int		$level
	 * @return SimpleXMLElement	The added child object
	 */
	...
	/**
	 * traverses the tree calling the $callback(SimpleXMLElement
	 * $this, mixed $args=array()) function with each SimpleXMLElement.
	 *
