...
class Date extends DateTime 
{
	...
	{
		switch ($month) {
			case 1:  return $abbr ? 'JANUARY_SHORT'	: 'JANUARY';
			case 2:  return $abbr ? 'FEBRUARY_SHORT'	: 'FEBRUARY';
			case 3:  return $abbr ? 'MARCH_SHORT'		: 'MARCH';
			case 4:  return $abbr ? 'APRIL_SHORT'		: 'APRIL';
			case 5:  return $abbr ? 'MAY_SHORT'		: 'MAY';
			case 6:  return $abbr ? 'JUNE_SHORT'		: 'JUNE';
			case 7:  return $abbr ? 'JULY_SHORT'		: 'JULY';
			case 8:  return $abbr ? 'AUGUST_SHORT'	: 'AUGUST';
			case 9:  return $abbr ? 'SEPTEMBER_SHORT'	: 'SEPTEMBER';
			case 10: return $abbr ? 'OCTOBER_SHORT'	: 'OCTOBER';
			case 11: return $abbr ? 'NOVEMBER_SHORT'	: 'NOVEMBER';
			case 12: return $abbr ? 'DECEMBER_SHORT'	: 'DECEMBER';
		}
	}
